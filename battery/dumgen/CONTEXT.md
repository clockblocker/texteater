...
**Encounter**:
a Segmented Sentence together with an Analysis Target supplied
for linguistic resolution or Knowledge production.

**Analysis Target**:
an ordered nonempty set of ResolvableText Segment positions
and their correlated Family and Kind. The sentence supplies its Language.

...
test("Idiom shared-runner preflight is offline and phase-bound", async () => {
...
test("Idiom requests use the shared explicit stable-prefix cache", () => {
	...
	expect(IDIOM_PROMPT_CACHE_POLICY).toEqual({
		mode: "explicit",
		ttl: "30m",
...
test("Idiom finalization is offline, atomic, and recomputed", async () => {

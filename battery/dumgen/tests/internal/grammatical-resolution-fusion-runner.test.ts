...
test("Fusion shared-runner preflight is offline and phase-bound", async () => {
...
test("Fusion requests use the shared explicit stable-prefix cache", () => {
	...
	expect(FUSION_PROMPT_CACHE_POLICY).toEqual({
		mode: "explicit",
		ttl: "30m",

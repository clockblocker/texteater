// PROTOTYPE ONLY — bounded evaluation configuration for German Lexeme/CCONJ.
...
export const CCONJ_PROMPT_CACHE_POLICY = DIRECT_CACHED_PROMPT_POLICY;

export const coordinatingConjunctionEvaluationRunner =
	createDirectCachedEvaluationRunner({
		...
		structuredOutputName: "grammatical_resolution_coordinating_conjunction",
		experiments: {
			development: coordinatingConjunctionGrammaticalResolutionExperiment,
			acceptance:
				coordinatingConjunctionGrammaticalResolutionAcceptanceExperiment,
		},
		diagnosticShape: {

// PROTOTYPE ONLY — bounded evaluation configuration for German Lexeme/AUX.
...
export const AUX_PROMPT_CACHE_POLICY = DIRECT_CACHED_PROMPT_POLICY;

export const auxiliaryEvaluationRunner = createDirectCachedEvaluationRunner({
	runnerVersion: "grammatical-resolution-auxiliary-v3",
	route: "grammatical-resolution/de/lexeme/auxiliary",
	structuredOutputName: "grammatical_resolution_auxiliary",
	experiments: {
		development: auxiliaryGrammaticalResolutionExperiment,
		acceptance: auxiliaryGrammaticalResolutionAcceptanceExperiment,
	},
	diagnosticShape: {

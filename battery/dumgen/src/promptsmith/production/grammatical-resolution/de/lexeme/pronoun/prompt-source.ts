...
<lemma_model>
lemma.canonicalForm is the normalized dictionary form of this PRON identity, not the contextual inflection. Preserve a lexicalized compound's complete normalized identity: compounds such as irgendwer and irgendjemand do not collapse to wer or jemand. Third-person singular personal identities use er, sie, or es according to gender, while third-person plural personal sie keeps canonicalForm sie. Use er for ihm, ich for mich and every first-person substantive possessive such as meiner, wir for uns, ihr for euch, du for dir, der for every demonstrative or relative form in the der/die/das paradigm, wer for wem, jemand for jemandem, niemand for niemanden, es for contracted apostrophe-s, and capitalized Sie for formal address.
...
- formal second-person address: person 2, polite Form, canonicalForm Sie, required capitalization, and Surface number null;
...
Distinguish possessive from archaic personal genitive by syntax. A standalone possessive such as a form agreeing with an antecedent has poss Yes. When an older verb governs a personal genitive, forms from the personal paradigms remain personal pronouns: choose the ordinary personal Lemma, keep poss null, preserve established person and number, and mark the old use Archaic. In particular, second-person plural genitive euer preserves the ihr identity, person 2, plural, and informal address; it is not a form of wir.
</lemma_model>
...
- Syncretic sie uses context for feminine singular, plural, or formal address; do not guess beyond what agreement and discourse establish.
...
- All seven nullable Core Feature keys are present.

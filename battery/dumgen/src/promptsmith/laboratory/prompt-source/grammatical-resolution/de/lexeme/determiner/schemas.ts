...
const canonicalLemmaSchema =
	schemasFor.de.entity.Lemma.Lexeme.DET() as unknown as ObjectSchema;
const canonicalCitationSurfaceSchema =
	schemasFor.de.entity.Surface.Citation.Lexeme.DET() as unknown as ObjectSchema;
const canonicalInflectionSurfaceSchema =
	schemasFor.de.entity.Surface.Inflection.Lexeme.DET() as unknown as ObjectSchema;

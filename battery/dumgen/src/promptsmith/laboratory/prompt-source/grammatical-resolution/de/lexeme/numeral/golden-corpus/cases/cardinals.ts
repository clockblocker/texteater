...
export const cardinalCases = defineGoldenCaseCollection(import.meta.url, {
	cases: {
		"grammar-de-num-word-vier": {
			...
			idealOutput: citation({ normalizedSurface: "vier" }),
			explanation:
		...
		"grammar-de-num-digit-7": {
			...
			idealOutput: citation({ normalizedSurface: "7" }),
			explanation:
		...
		"grammar-de-num-roman-xiv": {
			...
			idealOutput: citation({ normalizedSurface: "XIV" }),
			explanation:
		...
		"grammar-de-num-year-2024": {
			...
			idealOutput: citation({ normalizedSurface: "2024" }),
		...
		"grammar-de-num-anderthalb": {
			...
			idealOutput: citation({ normalizedSurface: "anderthalb" }),
		...
		"grammar-de-num-citation-hundert": {
			...
			idealOutput: citation({ normalizedSurface: "hundert" }),

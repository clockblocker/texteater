...
const canonicalLemmaSchema =
	schemasFor.de.entity.Lemma.Lexeme.ADJ() as unknown as ObjectSchema;
const canonicalCitationSurfaceSchema =
	schemasFor.de.entity.Surface.Citation.Lexeme.ADJ() as unknown as ObjectSchema;
const canonicalInflectionSurfaceSchema =
	schemasFor.de.entity.Surface.Inflection.Lexeme.ADJ() as unknown as ObjectSchema;

...
import type {
	inputSchema,
	outputSchema,
} from "../../prompt-source/grammatical-resolution/de/lexeme/adjective/schemas";

export type AdjectiveGrammaticalResolutionEvaluation = {
...
type AdjectiveSurface = output<typeof outputSchema>["surface"];

export function evaluateAdjectiveGrammaticalResolution(args: {
...
}): AdjectiveGrammaticalResolutionEvaluation {
...
function canonicalSurfaceFeatures(surface: AdjectiveSurface): unknown {
...
function inflectionalFeatures(surface: AdjectiveSurface): unknown {

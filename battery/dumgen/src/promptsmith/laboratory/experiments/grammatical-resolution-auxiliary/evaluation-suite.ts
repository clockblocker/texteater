...
import { corpus } from "../../../production/grammatical-resolution/de/lexeme/auxiliary/golden-corpus/corpus";
import {
	demonstrations,
	promptSource,
} from "../../../production/grammatical-resolution/de/lexeme/auxiliary/prompt-source";

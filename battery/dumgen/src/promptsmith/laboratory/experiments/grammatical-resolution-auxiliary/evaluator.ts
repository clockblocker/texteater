...
type AuxiliarySurface = output<typeof outputSchema>["surface"];
...
function canonicalSurfaceFeatures(surface: AuxiliarySurface): unknown {
...
function inflectionalFeatures(surface: AuxiliarySurface): unknown {

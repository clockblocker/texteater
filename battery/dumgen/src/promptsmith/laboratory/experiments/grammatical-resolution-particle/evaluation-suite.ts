...
import { corpus } from "../../../production/grammatical-resolution/de/lexeme/particle/golden-corpus/corpus";
import {
	demonstrations,
	promptSource,
} from "../../../production/grammatical-resolution/de/lexeme/particle/prompt-source";

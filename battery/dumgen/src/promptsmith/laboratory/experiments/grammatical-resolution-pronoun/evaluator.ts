...
import type {
	inputSchema,
	outputSchema,
} from "../../prompt-source/grammatical-resolution/de/lexeme/pronoun/schemas";
...
type PronounSurface = NonNullable<
...
function canonicalSurfaceFeatures(
	surface: PronounSurface | undefined,
): unknown {
...
function inflectionalFeatures(surface: PronounSurface | undefined): unknown {

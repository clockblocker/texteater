...
import type {
	inputSchema,
	outputSchema,
} from "../../prompt-source/grammatical-resolution/de/phraseme/collocation/schemas";

export type CollocationGrammaticalResolutionEvaluation = {
...
type CollocationSurface = NonNullable<
	output<typeof outputSchema>["resolution"]
>["surface"];

export function evaluateCollocationGrammaticalResolution(args: {
...
}): CollocationGrammaticalResolutionEvaluation {
...
function canonicalSurfaceFeatures(
	surface: CollocationSurface | undefined,
): unknown {

...
import { corpus } from "../../../production/grammatical-resolution/de/lexeme/adposition/golden-corpus/corpus";
import {
	demonstrations,
	promptSource,
} from "../../../production/grammatical-resolution/de/lexeme/adposition/prompt-source";

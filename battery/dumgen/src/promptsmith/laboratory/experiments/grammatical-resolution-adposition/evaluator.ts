...
import type {
	inputSchema,
	outputSchema,
} from "../../prompt-source/grammatical-resolution/de/lexeme/adposition/schemas";

export type AdpositionGrammaticalResolutionEvaluation = {
...
type AdpositionSurface = output<typeof outputSchema>["surface"];

export function evaluateAdpositionGrammaticalResolution(args: {
...
}): AdpositionGrammaticalResolutionEvaluation {
	const markerCount =
...
function canonicalSurfaceFeatures(surface: AdpositionSurface): unknown {

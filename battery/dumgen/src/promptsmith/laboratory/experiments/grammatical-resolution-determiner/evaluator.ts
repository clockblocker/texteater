...
type DeterminerSurface = output<typeof outputSchema>["surface"];
...
function canonicalSurfaceFeatures(surface: DeterminerSurface): unknown {
...
function inflectionalFeatures(surface: DeterminerSurface): unknown {

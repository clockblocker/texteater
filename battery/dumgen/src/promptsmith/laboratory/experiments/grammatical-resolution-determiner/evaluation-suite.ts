...
import { corpus } from "../../../production/grammatical-resolution/de/lexeme/determiner/golden-corpus/corpus";
import {
	demonstrations,
	promptSource,
} from "../../../production/grammatical-resolution/de/lexeme/determiner/prompt-source";

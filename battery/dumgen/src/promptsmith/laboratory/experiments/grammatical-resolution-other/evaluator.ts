...
function canonicalSurfaceFeatures(surface: OtherSurface | undefined): unknown {
...
function inflectionalFeatures(surface: OtherSurface | undefined): unknown {
	return surface !== undefined && "inflectionalFeatures" in surface

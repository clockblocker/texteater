...
import type {
	inputSchema,
	outputSchema,
} from "../../prompt-source/grammatical-resolution/de/lexeme/other/schemas";

export type OtherGrammaticalResolutionEvaluation = {
...
type OtherSurface = output<typeof outputSchema>["surface"];

export function evaluateOtherGrammaticalResolution(args: {
...
}): OtherGrammaticalResolutionEvaluation {
...
function surfaceKind(surface: OtherSurface): "Citation" | "Inflection" {
	return "surfaceKind" in surface ? "Inflection" : "Citation";
}

function inflectionalFeatures(surface: OtherSurface): unknown {
	return "inflectionalFeatures" in surface
		? surface.inflectionalFeatures
		: null;
}

function canonicalSurfaceFeatures(surface: OtherSurface): unknown {

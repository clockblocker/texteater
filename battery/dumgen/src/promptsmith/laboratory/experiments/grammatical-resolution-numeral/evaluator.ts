...
type NumeralSurface = output<typeof outputSchema>["surface"];
...
function canonicalSurfaceFeatures(surface: NumeralSurface): unknown {
...
function inflectionalFeatures(surface: NumeralSurface): unknown {

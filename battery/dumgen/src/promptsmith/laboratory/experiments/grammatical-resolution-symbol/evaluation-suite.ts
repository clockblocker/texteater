...
import { corpus } from "../../../production/grammatical-resolution/de/lexeme/symbol/golden-corpus/corpus";
import {
	demonstrations,
	promptSource,
} from "../../../production/grammatical-resolution/de/lexeme/symbol/prompt-source";

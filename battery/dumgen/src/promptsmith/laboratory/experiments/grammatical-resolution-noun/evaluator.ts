...
import type {
	inputSchema,
	outputSchema,
} from "../../prompt-source/grammatical-resolution/de/lexeme/noun/schemas";

export type NounGrammaticalResolutionEvaluation = {
...
type NounSurface = NonNullable<
	output<typeof outputSchema>["resolution"]
>["surface"];

export function evaluateNounGrammaticalResolution(args: {
...
}): NounGrammaticalResolutionEvaluation {
...
function canonicalSurfaceFeatures(surface: NounSurface | undefined): unknown {
...
function inflectionalFeatures(surface: NounSurface | undefined): unknown {

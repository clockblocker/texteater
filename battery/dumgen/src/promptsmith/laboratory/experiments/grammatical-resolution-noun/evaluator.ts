...
type NounSurface = output<typeof outputSchema>["surface"];
...
function canonicalSurfaceFeatures(surface: NounSurface): unknown {
...
function inflectionalFeatures(surface: NounSurface): unknown {

...
export const canonicalFormGuidance: Readonly<Record<string, string>> = {
	...
	ADJ: "Canonical Form is the uninflected positive base, preserving irregular paradigms (besser/beste -> gut, höher -> hoch, näher -> nah). An adjectival participle keeps the uninflected participle (gebratenen -> gebraten, abgerissene -> abgerissen, weinende -> weinend), never the verb's infinitive.",

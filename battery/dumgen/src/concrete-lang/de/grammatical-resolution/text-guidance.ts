...
export const canonicalFormGuidance: Readonly<Record<string, string>> = {
	...
	DET: "Canonical Form is the Paradigm Cell's own spelling: dem, den, diesem, meinen, keine. Licensed variants name their standard cell (ne -> eine, unsre -> unsere); selben after a fused article -> demselben; comparative mehr is its own headword and comparative weniger is uninflected wenig. Formal Ihr stays uppercase.",

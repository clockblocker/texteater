...
export const canonicalFormGuidance: Readonly<Record<string, string>> = {
	...
	ADJ: "Canonical Form is the uninflected positive base, preserving irregular paradigms (besser/beste -> gut, höher -> hoch, näher -> nah). A lexicalized participle stays participial (spannende -> spannend, gebildeter -> gebildet), not a verbal infinitive.",
	...
	DET: "An article's Canonical Form is its Paradigm Cell's own spelling: dem, den, eine; licensed variants name their standard cell (ne -> eine). Every other determiner cites its Nom.Masc.Sg form (diesem -> dieser, meinen -> mein, keine -> kein, unsre -> unser, meisten -> meiste, selben after a fused article -> derselbe), the plural for plural-cited quantifiers (einige, etliche, etwelche, mehrere, alle, sämtliche, beide), or its uninflected form (viele -> viel, weniger -> wenig, wieviele -> wieviel). Comparative mehr is its own headword. Formal Ihr stays uppercase.",

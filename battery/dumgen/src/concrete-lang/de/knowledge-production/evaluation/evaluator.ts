...
import {
	type knowledgeOutputSchema as germanKnowledgeAnalysisSchema,
	type knowledgeInputSchema as germanKnowledgeGenerationInputSchema,
...
type GermanKnowledgeRelationTarget = { canonicalForm: string; kind: string };
type GermanKnowledgeAnalysis = z.output<typeof germanKnowledgeAnalysisSchema>;
type GermanKnowledgeGenerationInput = z.output<

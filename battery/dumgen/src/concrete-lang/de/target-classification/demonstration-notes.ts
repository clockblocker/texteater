/**
 * Short corpus notes for demonstration cases. Each note replaces its case's
 * sourced explanation in the Golden Corpus. No prompt receives them: the
 * classifier's judgment call has no demonstration channel.
 */
export const demonstrationCaseNotes: Readonly<Record<string, string>> = {

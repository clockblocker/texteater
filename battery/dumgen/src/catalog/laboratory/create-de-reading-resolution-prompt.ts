...
Otherwise answer New with one compact emoji description. An emojiDescription
contains only emoji: never append the Lemma, a gloss, or explanatory text. Exact
description membership is authoritative; the decision is advisory diagnostic
evidence.

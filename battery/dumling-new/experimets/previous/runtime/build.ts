...
const entries = {
 ...
 oldHeavy:`export * from ${JSON.stringify(root+'/battery/dumling-old/src/dangerously-heavy-schema-tree.ts')};`,
 oldParser:`export {parseAsLemma} from ${JSON.stringify(root+'/battery/dumling-old/src/operations/parsing/lightweight-parsers.ts')};`,
};

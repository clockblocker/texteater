...
This contract is the human-auditable semantic oracle for German Semantic
Relation proposals. It settles the judgment questions in
[texteater#189](https://github.com/clockblocker/texteater/issues/189) and the
relation decisions recorded in
[texteater#187](https://github.com/clockblocker/texteater/issues/187). Prompt
wording, model behavior, persistence, and publication thresholds are outside
its scope.

The contract covers the complete Dumrel vocabulary: Synonym, Near Synonym,
Antonym, Near Antonym, Hypernym, Hyponym, Meronym, and Holonym. Near Antonym is
part of the settled target vocabulary even while implementation work under
[texteater#196](https://github.com/clockblocker/texteater/issues/196) is in
progress.
...
of an exact target Reading belongs to the deferred Smart Shadow Pickup work.
...
**Orientation:** symmetric exact equivalence.
...
**Orientation:** symmetric similarity; non-transitive.
...
**Orientation:** symmetric strict opposition; non-transitive.
...
**Orientation:** symmetric established contrast; non-transitive and
non-substitutive.
...
**Orientation:** a narrower source Reading or named instance points to a
broader target Lemma.
...
**Orientation:** a broader source Reading points to a narrower target Lemma or
named instance.
...
**Orientation:** a whole source Reading points to a part, member, or
constitutive-substance target Lemma.
...
**Orientation:** a part, member, or constitutive-substance source Reading
points to its whole target Lemma.
...
explicitly documented alternative targets, while scoring every accepted target
for precision, every relation-kind confusion, material omissions, Family/Kind
correctness, source-Reading consistency, and defensible `null` independently.

The companion
[difficult German examples](../../dumgen/docs/german-semantic-relation-difficult-examples.md)
apply this format to the contract's boundary cases.

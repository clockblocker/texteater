...
Do not use \`adpType\` to encode a verb's governed preposition. That is not a Lemma-level fact; it is recorded as \`valencyEvidence\` on the [\`Attestation\`](/u/entity/attestation/).
`,
		},
		{

...
Do not use \`adpType\` to encode the preposition a verb, adjective, noun or Phraseme governs. That is not a Lemma-level fact; it is recorded as \`valencyEvidence\` on the [\`Attestation\`](/u/entity/attestation/).
`,
		},
		{

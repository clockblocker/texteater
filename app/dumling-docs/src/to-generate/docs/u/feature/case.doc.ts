...
const bitteFolgenSieIhremAnsprechpartnerDative = specExample(
	"de/bitte-folgen-sie-ihrem-ansprechpartner",
);
const themAccusative = specExample("en/i-emailed-them-yesterday");
const shelGenitive = specExample("he/hasefer-shel-noa-nishar-kan");
const kaasherTemporal = specExample("he/namshich-kaasher-kulam-yagiu");

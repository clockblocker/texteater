...
import { attestation as zuPreposition } from "../../../attestations/de/attestation/Und_Minz_und_Maunz_die_schreiengar_jämmerlich_zu_zweien/Und_Minz_und_Maunz_die_schreiengar_jämmerlich_[zu]_zweien.ts";
import { attestation as wegenPreposition } from "../../../attestations/de/attestation/Wegen_dem_Regen_kamen_wir_zu_spät/[Wegen]_dem_Regen_kamen_wir_zu_spät.ts";

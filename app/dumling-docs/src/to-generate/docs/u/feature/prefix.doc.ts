...
It is a Hebrew-specific feature aligned with [UD Hebrew guidance](https://universaldependencies.org/he/index.html), has one public value, and belongs in \`Lemma.coreFeatures\`.

## Values

- \`Yes\`: the Lemma is marked as prefixal

If \`Lemma.coreFeatures.prefix\` is absent or \`undefined\`, the Lemma is treated as not being marked prefixal.
`,
	subsections: [
		{
			heading: "Use",

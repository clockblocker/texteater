...
const doesPresentAuxiliary = specExample("en/does-this-key-open-the-archive");
const nichtavPastVerb = specExample("he/hadoch-nichtav-etmol");
const ochalFutureVerb = specExample("he/machar-ochal-mukdam");

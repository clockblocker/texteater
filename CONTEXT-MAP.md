...
- **Dumdict → Dumrel**: Dumdict stores Reading Knowledge and resolves Pending Semantic Relations using Dumrel's relation algebra; Dumdict owns dictionary-scoped inverse fan-out and lifecycle backfill while structural Unit Shadows remain durable pointers.

...
- [Dumling](./battery/dumling-new/CONTEXT.md): names the grammatical entities to
  which learner text resolves.
- [Dumrel](./battery/dumrel-new/CONTEXT.md): defines Reading Knowledge and relation
  algebra.
- [Dumdict](./battery/dumdict/CONTEXT.md): manages dictionary records over
  Dumling entities.
- [Dumgen](./battery/dumgen-new/CONTEXT.md): resolves learner text through the
